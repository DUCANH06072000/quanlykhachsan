...
namespace QuanLy_KhachSan
{
    class chuoiketnoi
    {
        public static string sqlcon = @"Data Source=DESKTOP-1LUVJJ9;Initial Catalog=Hotel_Manager_Data;Integrated Security=True";
        ...
        public static void them(String sql)
        {
        ...
        public static DataTable Tenkhach()
        {
            mycon = new SqlConnection(sqlcon);
            mycon.Open();
