...
namespace QuanLy_KhachSan.quanly_dat_thue_phong
{
    public partial class Thue_phong : Form
    {
        ...
        {
            DataTable table = hamhotro.ouput_colum_data.TenPhong();
            txt_id_phong.DisplayMember = "MaPhong";
            //    txt_makh.ValueMember = "TenKh";
            txt_id_phong.DataSource = table;
            lb_phong.DataBindings.Add("text", table, "TenPhong");

        }

        public void load_khach()
        {
            DataTable table = hamhotro.ouput_colum_data.Tenkhach();
            txt_id_khach.DisplayMember = "MaKh";
            //    txt_makh.ValueMember = "TenKh";
            txt_id_khach.DataSource = table;
            lb_khach.DataBindings.Add("text", table, "Tenkh");

        }
        public void load_NV()
        {

            DataTable table = hamhotro.ouput_colum_data.TenNV();
            txt_id_nv.DisplayMember = "Manv";
            //    txt_makh.ValueMember = "TenKh";
            txt_id_nv.DataSource = table;
            lb_nhanvien.DataBindings.Add("text", table, "Tennv");
        }
