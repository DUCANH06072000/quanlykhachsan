    ...
    public partial class Phuthu_Manager : Form
    {
        ...
        private void txt_makh_TextChanged(object sender, EventArgs e)
        {
         //   string a = txt_makh.SelectedValue.ToString();
            ...
            //    string tendaydu = chuoiketnoi.load_tenkhach(chuoi4, a);
        ...
        {
            DataTable table = chuoiketnoi.Tenkhach();
            txt_makh.DisplayMember = "MaKh";
        //    txt_makh.ValueMember = "TenKh";
            txt_makh.DataSource = table;
            lb_tenk.DataBindings.Add("text", table, "Tenkh");
        }
        ...
        private void lb_tenk_Click(object sender, EventArgs e)
        {
